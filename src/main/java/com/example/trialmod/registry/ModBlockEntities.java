...
public class ModBlockEntities {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, TrialMod.MOD_ID);
    ...
    public static final RegistryObject<BlockEntityType<com.example.trialmod.block.HookBlockEntity>> HOOK_BE =
            BLOCK_ENTITIES.register("hook", () -> BlockEntityType.Builder.of(
                    com.example.trialmod.block.HookBlockEntity::new, ModBlocks.HOOK.get()).build(null));
